import { tilesForTrack, ZOOM, splitTrackOnJumps } from "./tiles.js";
...
function rasterizeTrace(pts, n, fine) {
  ...
  // même découpe aux sauts GPS que tilesForTrack : sans elle, la fausse
  // ligne droite d'un décrochage serait rasterisée puis SOUDÉE par la
  // fermeture morphologique, capturant du territoire à travers le pays
  for (const part of splitTrackOnJumps(pts)) {
    let prev = null;
